...
сведены в @fig-ci-comparison-table[таблицу]. В таблицу также был включен
разрабатываемый проект "Swompi-Runner" для демонстрации его позиционирования
относительно рассмотренных аналогов.
